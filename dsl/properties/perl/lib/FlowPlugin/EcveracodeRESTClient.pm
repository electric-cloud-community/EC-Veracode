...
package FlowPlugin::EcveracodeRESTClient;
use strict;
use warnings;
use LWP::UserAgent;
use JSON;
...
use FlowPDF::Log;
## DO NOT EDIT THIS BLOCK ABOVE ^^^=== rest client imports ends, checksum: 96de9cbe938464eeae7c98c2e0e96f57 ===
# Place for the custom user imports, e.g. use File::Spec
## DO NOT EDIT THIS BLOCK BELOW=== rest client starts ===
=head1

FlowPlugin::EcveracodeRESTClient->new('http://endpoint', {
...
use constant {
    ...
    USER_AGENT => 'EcveracodeRESTClient REST Client',
...
Use this method to create a new FlowPlugin::EcveracodeRESTClient, e.g.

    my $client = FlowPlugin::EcveracodeRESTClient->new($endpoint,
...
sub getDetailedReport {
    ...
    $self->{method} = 'getDetailedReport';
    $self->{methodParameters} = \%params;

    my $uri = "api/5.0/detailedreport.do?build_id={{build_id}}";
...
## DO NOT EDIT THIS BLOCK ABOVE ^^^=== rest client ends, checksum: 9a2b21a8638d79d98ffbc94e07758986 ===
=pod
